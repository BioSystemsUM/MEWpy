...
class RFBAModel(IntegratedModel):
    ...
    def solve_regulatory_model(self, state, silently=False):
        ...
        :param state: dict, key is the id of the regulatory variable while value can be 0, 1 or float (reactions
        and metabolites predicates)
    ...
    def next_state(self, state):
        ...
        :param state: dict, dict, key is the id of the regulatory variable while value can be 0, 1 or float (reactions
        and metabolites predicates)
        :return: dict, for convenience returns dict of all regulatory variables where key is the id of the regulatory
        variable and value can be 0, 1 or float (reactions and metabolites predicates)
        """
