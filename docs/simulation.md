...
In addition, our `mewpy.mew` sub-package can be used to load metabolic models in SBML, JSON, COBRApy model or Reframed model formats. 
Consult the [documentation](https://mewpy.readthedocs.io/en/latest/mew.html) for more information.
